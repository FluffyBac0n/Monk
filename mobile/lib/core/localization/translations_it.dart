const italianTranslations = <String, String>{
  ...
  'Open and edit': 'Apri e modifica',
  'Start date': 'Data di partenza',
  'Choose section': 'Scegli tratto',
  'Custom': 'Personalizzato',
  'Suggested': 'Suggerito',
  'Smart': 'Smart',
  'Walking days': 'Giorni di cammino',
  'Swap start and finish': 'Scambia partenza e arrivo',
  'Choose stage': 'Scegli tappa',
  'Search by stage or place': 'Cerca per tappa o luogo',
  'Water': 'Acqua',
  'per night': 'a notte',
  'Flexible': 'Flessibile',
  'Set as start': 'Imposta come partenza',
  'Set as finish': 'Imposta come arrivo',
  'What should the planner hold fixed?':
      'Cosa deve mantenere fisso il pianificatore?',
  'Fit my days': 'Adatta ai miei giorni',
  'Limit effort': 'Limita lo sforzo',
  'Remove walking day': 'Rimuovi giorno di cammino',
  'Add walking day': 'Aggiungi giorno di cammino',
  'We will choose the number of days that stays within your daily limit.':
      'Sceglieremo il numero di giorni che rispetta il tuo limite quotidiano.',
  'Walking time includes an allowance for climbing. Route styles rank alternatives without changing this limit.':
      'Il tempo include un margine per le salite. Gli stili ordinano le alternative senza cambiare questo limite.',
  'Required average': 'Media necessaria',
  'Projected finish': 'Arrivo previsto',
  'Use suggested days': 'Usa giorni suggeriti',
  'Include stays without a listed price':
      'Includi soggiorni senza prezzo indicato',
  'You can confirm their price before booking.':
      'Puoi confermare il prezzo prima di prenotare.',
  'Save route': 'Salva percorso',
  'Review pace': 'Rivedi ritmo',
  'Review stays': 'Rivedi pernottamenti',
  'Recommended': 'Consigliato',
  'average': 'in media',
  'Longest day': 'Giorno più lungo',
  'Camping nights': 'Notti in campeggio',
  'Choose two stages in trail order.':
      'Scegli due tappe nell’ordine del sentiero.',
  'This section is too far for the selected number of days.':
      'Questo tratto è troppo lungo per i giorni selezionati.',
  'This short section has fewer useful stops than selected days.':
      'Questo tratto breve ha meno soste utili dei giorni selezionati.',
  'One or more trail sections exceed your daily effort limit.':
      'Uno o più tratti superano il tuo limite di sforzo giornaliero.',
  'A suitable stay is available, but its price is not listed.':
      'È disponibile un soggiorno adatto, ma il prezzo non è indicato.',
  'No listed stays fit the selected price range.':
      'Nessun soggiorno indicato rientra nella fascia di prezzo.',
  'The selected stay type is not available at the required stops.':
      'Il tipo di soggiorno scelto non è disponibile alle soste necessarie.',
  'The available overnight stops cannot make this exact day count.':
      'Le soste disponibili non consentono questo numero esatto di giorni.',
  'There are not enough suitable overnight stops for this section.':
      'Non ci sono abbastanza soste adatte per questo tratto.',
  'Tap a stage on the map to choose your start, then your finish.':
      'Tocca una tappa sulla mappa per scegliere la partenza e poi l’arrivo.',
  'Choose two different stages.': 'Scegli due tappe diverse.',
  'Show my location': 'Mostra la mia posizione',
  'Center trail': 'Centra il percorso',
  'Show all stages': 'Mostra tutte le tappe',
  'Choose start': 'Scegli partenza',
  'Choose finish': 'Scegli arrivo',
  'Choose a different stage for the finish.':
      'Scegli una tappa diversa per l’arrivo.',
  'Choose a start and finish stage.':
      'Scegli una tappa di partenza e una di arrivo.',
  'The planner will choose the best-fitting section.':
      'Il pianificatore sceglierà il tratto più adatto.',
  'Move overnight stop': 'Sposta pernottamento',
  'Choose where to stay': 'Scegli dove pernottare',
  'No accommodation is listed at this stop.':
      'Nessun alloggio è indicato per questa tappa.',
  'Move stop': 'Sposta tappa',
  'Choose stay': 'Scegli alloggio',
  'Start this day': 'Inizia questa giornata',
  'Your route at a glance': 'Il percorso in sintesi',
  'Route map is loading…': 'Caricamento della mappa…',
  'Day': 'Giorno',
  'Offline readiness': 'Preparazione offline',
  'Offline map download in progress': 'Download della mappa offline in corso',
  'Download the trail map before you leave coverage.':
      'Scarica la mappa del sentiero prima di perdere la copertura.',
  'Open map': 'Apri mappa',
  'Manage': 'Gestisci',
  'from trail': 'dal sentiero',
  'Open': 'Aperto',
  'Confirm availability for your planned date.':
      'Conferma la disponibilità per la data prevista.',
  'Pafos to Larnaka': 'Da Pafo a Larnaca',
  'Larnaka to Pafos': 'Da Larnaca a Pafo',
  'No routes saved yet': 'Nessun percorso salvato',
  'Create a route to keep its itinerary and use it in Stage filters.':
      'Crea un percorso per conservarne l’itinerario e usarlo nei filtri delle tappe.',
  'Saved routes are unavailable.': 'I percorsi salvati non sono disponibili.',
  'Delete route': 'Elimina percorso',
  'Delete this saved route?': 'Eliminare questo percorso salvato?',
  'Preferences': 'Preferenze',
  'Itinerary': 'Itinerario',
  'Choose your route': 'Scegli il percorso',
  'Finish must come after the start in the current direction.':
      'L’arrivo deve trovarsi dopo la partenza nella direzione attuale.',
  'Compare': 'Confronta',
  'Choose an itinerary': 'Scegli un itinerario',
  'Budget': 'Economico',
  'Balanced': 'Bilanciato',
  'Comfort': 'Comfort',
  'Unavailable for these preferences': 'Non disponibile per queste preferenze',
  'Done': 'Fine',
  'Saved to My routes and Stage filters.':
      'Salvato in I miei percorsi e nei filtri delle tappe.',
  'Build a stage-to-stage itinerary': 'Crea un itinerario tappa per tappa',
  'Choose your daily limits and overnight requirements. The planner uses the current E4 stage and accommodation data.':
      'Scegli i limiti giornalieri e le esigenze di pernottamento. Il pianificatore usa i dati attuali delle tappe e degli alloggi E4.',
  'Daily walking limits': 'Limiti giornalieri di cammino',
  'Minimum': 'Minimo',
  'Maximum': 'Massimo',
  'Overnight stops': 'Pernottamenti',
  'Accommodation budget': 'Budget per gli alloggi',
  'Leave empty for no budget limit.':
      'Lascia vuoto per nessun limite di budget.',
  'Allow camping stages': 'Consenti tappe in campeggio',
  'Use camping when no accommodation stop fits the daily limits.':
      'Usa il campeggio quando nessun alloggio rispetta i limiti giornalieri.',
  'Find route': 'Trova percorso',
  ...
  'Trail data is unavailable.': 'I dati del percorso non sono disponibili.',
  'Balanced route found': 'Percorso equilibrato trovato',
  'walking days': 'giorni di cammino',
  'total distance': 'distanza totale',
  'known prices': 'prezzi noti',
  '{count} overnight prices are unknown. Confirm prices and availability before travelling.':
      'I prezzi di {count} pernottamenti non sono noti. Conferma prezzi e disponibilità prima del viaggio.',
  'Day-by-day itinerary': 'Itinerario giorno per giorno',
  'Walking times and prices are estimates. Check weather, trail conditions and accommodation availability before setting out.':
      'Tempi e prezzi sono stime. Controlla meteo, condizioni del percorso e disponibilità degli alloggi prima di partire.',
  'Camping stage': 'Tappa in campeggio',
  'Accommodation price unknown': 'Prezzo dell’alloggio sconosciuto',
  'No feasible route found': 'Nessun percorso fattibile trovato',
  'Try widening the daily distance range or increasing the accommodation budget.':
      'Prova ad ampliare la distanza giornaliera o ad aumentare il budget.',
  'Try widening the daily distance range, increasing the budget or allowing camping stages.':
      'Prova ad ampliare la distanza giornaliera, aumentare il budget o consentire il campeggio.',
  'Filter': 'Filtra',
  ...
  'Size': 'Dimensione',
  'Route points': 'Punti del percorso',
  ...
  'Remove trail data': 'Rimuovi dati del sentiero',
  'Try again': 'Riprova',
  'Cancel': 'Annulla',
  'Close': 'Chiudi',
  'Remove': 'Rimuovi',
  'Remove offline map?': 'Rimuovere la mappa offline?',
  'Remove trail data?': 'Rimuovere i dati del sentiero?',
  'The route, stages and elevation will be removed. The offline map will remain on this device.':
      'Il percorso, le tappe e il profilo altimetrico verranno rimossi. La mappa offline rimarrà su questo dispositivo.',
  'The trail data could not be removed.':
      'Impossibile rimuovere i dati del sentiero.',
